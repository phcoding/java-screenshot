...
public class SPanel extends JPanel {
	...
	private int SIDE=16;	//控制块边长
	private int OFFSET=SIDE%2==0?SIDE:SIDE+1;	//控制块偏移量
	
	//边界线及控制块颜色
	private Color COLOR_BORDER=new Color(51,255,76,255);
	private Color COLOR_BLOKE =new Color(0,0,0,0);
	...
	public SPanel() {
		...
		block_1.setBounds(0, 0, OFFSET, OFFSET);
		add(block_1);
		...
		block_2.setBounds(0, 0, OFFSET, OFFSET);
		add(block_2);
		...
		block_3.setBounds(0, 0, OFFSET, OFFSET);
		add(block_3);
		...
		block_4.setBounds(0, 0, OFFSET, OFFSET);
		add(block_4);
		...
		block_5.setBounds(0, 0, OFFSET, OFFSET);
		add(block_5);
		...
		block_6.setBounds(0, 0, OFFSET, OFFSET);
		add(block_6);
		...
		block_7.setBounds(0, 0, OFFSET, OFFSET);
		add(block_7);
...
//		g.drawRect(OFFSET/2, OFFSET/2, getWidth()-OFFSET, getHeight()-OFFSET);
		...
		//绘制控制块
		g2d.setColor(COLOR_BORDER);
		g2d.fillRoundRect(0, 0, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect((getWidth()-OFFSET)/2, 0, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect(getWidth()-OFFSET, 0, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect(0, (getHeight()-OFFSET)/2, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect(getWidth()-OFFSET, (getHeight()-OFFSET)/2, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect(0, getHeight()-OFFSET, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect((getWidth()-OFFSET)/2, getHeight()-OFFSET, OFFSET, OFFSET, OFFSET, OFFSET);
		g2d.fillRoundRect(getWidth()-OFFSET, getHeight()-OFFSET, OFFSET, OFFSET, OFFSET, OFFSET);
	}
